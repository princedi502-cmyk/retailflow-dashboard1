...
// Utility functions for offline status
  ...
  if ('serviceWorker' in navigator && 'PushManager' in window) {
    return navigator.serviceWorker.ready.then(registration => {
      const subscribeOptions = {
        ...
        applicationServerKey: urlBase64ToUint8Array('BEl62iUYgUivxIkv69yViEuiBIa-Ia9vZ-_V_dq8QjwjTtY5TmFA2yMhvsGQHMAc6Xr1I9Rh21R1Yw1kkxSb8C')
      };
...
// Helper function for push notification VAPID key
